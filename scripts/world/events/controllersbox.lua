...
--- `ControllersBox` is an [`Event`](lua://Event.init) - naming an object `chest` on an `objects` layer in a map creates this object. \
--- See this object's Fields for the configurable properties on this object.
---
---@class ControllersBox : Event
---
---@field sprite    Sprite
---@field solid     boolean
---
...
---
---@overload fun(...) : ControllersBox
local ControllersBox, super = Class(Event, "controllersbox")

function ControllersBox:init(x, y, properties)
    super.init(self, x, y)
    ...
    self.sprite = Sprite("world/events/controllersbox")
...
function ControllersBox:getDebugInfo()
...
function ControllersBox:onAdd(parent)
...
function ControllersBox:onInteract(player, dir)
    if self:getFlag("opened") then
        self.world:showText("* (The box is empty.)")
    else
